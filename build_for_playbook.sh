...
# Set a destination where everything gets installed.
PREFIX=$(pwd)/../install

# Add location of our hacked up configure scripts to the path
...
CPP="${PREFIX}/../porting-utils/bin/qcc -V4.4.2,gcc_ntoarmv7le_gpp -E " \
CC="${PREFIX}/../porting-utils/bin/qcc -V4.4.2,gcc_ntoarmv7le_gpp " \
